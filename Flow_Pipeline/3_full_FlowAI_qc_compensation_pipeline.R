...
python_path <- "/Users/sauterj1/anaconda3/bin/python3.8"
##################################################################################

if (!dir.exists(flow_dir_save_loc)) {
  stop(paste0('Flow directory location: ', flow_dir_save_loc, ' does not exist!'))
}
...
#=================================================================================
# cat('\n\nParsing and applying compensation ...\n\n')
# 
# flow_directories <- 
...
for (flow_directory in flow_directories) {
  ...
  # Parse compensation matrix if needed 
  command <-
    paste0(python_path, ' ',
           parse_comp_mat_python_path,
           " \"", flow_directory, "\"")
