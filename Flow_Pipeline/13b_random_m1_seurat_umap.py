...
m1_data = pd.read_feather('/gpfs/mskmind_ess/sauterj1/seurat/objects/M1_random_sample_seurat_expression_data.feather')
...
embedding = reducer.fit_transform(m1_data)

print('Saving Embedding ...')

# Save embedding and list of directories in order 
feather.write_feather(pd.DataFrame(embedding), 'M1_random_umap_results_100k_per_patient.feather')
