...
m1_data = pd.read_feather('/gpfs/mskmind_ess/sauterj1/seurat/objects/M1_SPADE_seurat_expression_data.feather')
...
feather.write_feather(pd.DataFrame(embedding), 'M1_spade_umap_results_100k_per_patient.feather')
