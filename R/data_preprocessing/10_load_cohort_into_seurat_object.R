...
# Save Seurat object
saveRDS(seurat_obj, 'M1_centralized_Seurat_object.Rds')
...
arrow::write_feather(seurat_expression_data,
                     'M1_seurat_expression_data.feather')
...
for (i in seq_along(flow_directories)) {
  ...
  fcs_path <- 
    file.path(flow_directories[[i]], 
              'processed_M2_subsampled_100k.fcs')
...
cat('\n\nSaving Seurat object\n\n')
# Save Seurat object
saveRDS(seurat_obj, 'M2_centralized_Seurat_object.Rds')
...
arrow::write_feather(seurat_expression_data,
                     'M2_seurat_expression_data.feather')
