...
m1_som <- readRDS('data/m1_som_100_cells_per_patient_10_by_10_dim_20_clus.Rds')
...
bmp('images/umap_som_clusters/umap_96_patients_10_by_10_dim_20_meta_clusters.bmp', 
    width = 1280*2, 
    height = 800*2)
